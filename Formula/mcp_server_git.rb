class McpServerGit < Formula
  include Language::Python::Virtualenv

  desc "Git MCP server"
  homepage "https://github.com/modelcontextprotocol/servers/tree/main/src/git"
  url "https://files.pythonhosted.org/packages/5a/43/a148baa2b1e8599eda07c4b40aa95ff357afc62515388e365e8f12e55ffa/mcp_server_git-2025.1.14.tar.gz"
  sha256 "34469d85b78370f4f167b7285da175ba735c7fccebfbf27569d9eed97bc467c2"
  license "MIT"
  ...
  test do
    assert_match(/Usage:/, shell_output("#{bin}/mcp-server-git --help"))
  end
end
